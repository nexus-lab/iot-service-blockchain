...
test('response.serialize()', () => {
  ...
  const serialized =
    '{"requestId":"ffbc9005-c62a-4563-a8f7-b32bba27d707","time":"2021-12-12T17:34:00.000-05:00",' +
...
test('response.validate()', () => {
  const response = new ServiceResponse('123456', moment(0));
  ...
  response.time = moment('2021-12-12T17:34:00-05:00');
